...
const MarketingPage = () => {
  return (
    <section className="flex items-center justify-center flex-col">
      ...
      >
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full text-amber-700 uppercase">
          <Medal className="h-6 w-6 mr-2" />
          No 1 task managment
        </div>
        <h1 className="text-3xl md:text-5xl txt-center text-neutral-800 mb-6">
        ...
        <p
          className={
            cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md_max-w-2xl text-center mx-auto",
              textFont.className
            ) }
        >
